...
int main(void) {
  ...
  task_t *task_1 = create_task(func, (void *)"foo", 0);
  task_t *task_2 = create_task(func, (void *)"bar", 1);
  task_t *task_3 = create_task(func, (void *)"baz", 2);
  task_t *task_4 = create_task(func, (void *)"qux", 3);
  task_t *task_5 = create_task(func, (void *)"blah", 4);
